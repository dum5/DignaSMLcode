...
%Errors
ax2a = axes('Position',[left  lower+2*delta+0.07 width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.2 0.25],'YTick',[-0.2 0 0.2],'FontSize',12,'FontName','Arial');
ax2b = axes('Position',[left+width2+0.04  lower+2*delta+0.07 width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 6.5],'YLim',[-0.2 0.25],'YTick',[-0.2 0 0.2 ],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
ax2c = axes('Position',[left+2*(width2+0.04)  lower+2*delta+0.07 width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.2 0.25],'YTick',[-0.2 0 0.2],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
...
%bar plots OG post
ax4a = axes('Position',[left  lower width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.05 0.15],'YTick',[0 0.1],'FontSize',12,'FontName','Arial');
ax4b = axes('Position',[left+width2+0.04  lower width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.05 0.15],'YTick',[0 0.1],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
ax4c = axes('Position',[left+2*(width2+0.04)  lower width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.05 0.15],'YTick',[0 0.1],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
...
errorbar(ax2b,1,nanmean(TCatch.netContributionNorm2_catch),nanstd(TCatch.netContributionNorm2_catch)./sqrt(length(TCatch.netContributionNorm2_catch)),...
    'Color','k','LineWidth',2)
bar(ax2b,3,nanmean(TCatch.netContributionNorm2_beforeCatch),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax2b,3,nanmean(TCatch.netContributionNorm2_beforeCatch),nanstd(TCatch.netContributionNorm2_beforeCatch)./sqrt(length(TCatch.netContributionNorm2_beforeCatch)),...
    'Color','k','LineWidth',2)
bar(ax2b,5,nanmean(TCatch.netContributionNorm2_resumeSplit),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax2b,5,nanmean(TCatch.netContributionNorm2_resumeSplit),nanstd(TCatch.netContributionNorm2_resumeSplit)./sqrt(length(TCatch.netContributionNorm2_resumeSplit)),...
    'Color','k','LineWidth',2)
...
plot(ax2b,[3 5],[0.025 0.025],'-k','LineWidth',2)
...
text(ax2b,2.5,-0.25,{'Before','Catch'},'FontSize',10,'FontName','Arial');
text(ax2b,4.5,-0.27,{'After','Catch'},'FontSize',10,'FontName','Arial')
...
ax1a = axes('Position',[left  lower width height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 2.5],'YLim',[0 100],'YTick',[0 50 100],'FontSize',12,'FontName','Arial');
ax1b = axes('Position',[left+width+0.1  lower width height],'Clipping','off','XLim',[0.5 2.5],'XTickLabel',{''},'YLim',[0 0.12],'FontSize',12,'FontName','Arial');
...
errorbar(ax1a,1,nanmean(TControl.netContributionNorm2_pctGeneralization),nanstd(TControl.netContributionNorm2_pctGeneralization)./sqrt(length(TControl.netContributionNorm2_pctGeneralization)),...
    'Color','k','LineWidth',2)
bar(ax1a,2,nanmean(TCatch.netContributionNorm2_pctGeneralization),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax1a,2,nanmean(TCatch.netContributionNorm2_pctGeneralization),nanstd(TCatch.netContributionNorm2_pctGeneralization)./sqrt(length(TCatch.netContributionNorm2_pctGeneralization)),...
    'Color','k','LineWidth',2)
...
errorbar(ax1b,1,nanmean(TControl.netContributionNorm2_LA_ERA),nanstd(TControl.netContributionNorm2_LA_ERA)./sqrt(length(TControl.netContributionNorm2_LA_ERA)),...
    'Color','k','LineWidth',2)
bar(ax1b,2,nanmean(TCatch.netContributionNorm2_LA_ERA),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax1b,2,nanmean(TCatch.netContributionNorm2_LA_ERA),nanstd(TCatch.netContributionNorm2_LA_ERA)./sqrt(length(TCatch.netContributionNorm2_LA_ERA)),...
    'Color','k','LineWidth',2)
