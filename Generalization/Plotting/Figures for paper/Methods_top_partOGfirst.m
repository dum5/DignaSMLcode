...
ax1 = axes('Position',[0.025  lower+3*delta+0.05 width height*0.4],'XTickLabel',{''},'YTickLabel',{''},'Clipping','off','XLim',[0 2400],'YLim',[0 1],'YTick',[-10 10000],'XTick',[-10 10000]);
...
% hatchfill2(hs)
patch(ax1,[1501 1800 1800 1501],[0 0 1 1],[1 1 1],'EdgeColor',[0 0 0],'LineWidth',2)
hs=patch(ax1,[2101 2400 2400 2101],[0 0 1 1],[1 1 1],'EdgeColor',[0 0 0],'LineWidth',2);
hatchfill2(hs)
%patch(ax1,[2101 2400 2400 2100],[0 0 0.5 0.5],[1 1 1],'EdgeColor',[0 0 0],'LineWidth',2)
text(ax1,10,0.5,'OG B','FontSize',12,'FontName','Arial')
text(ax1,310,0.5,'TM B','FontSize',12,'FontName','Arial','Color',[0 0 0])
text(ax1,810,0.5,'ADAP1','FontSize',12,'FontName','Arial','Color',[1 1 1])
text(ax1,1510,0.5,'OG P','FontSize',12,'FontName','Arial')
%text(ax1,1510,0.25,'TM P','FontSize',12,'FontName','Arial','Color',[0 0 0])
text(ax1,1810,0.5,'ADAP2','FontSize',12,'FontName','Arial','Color',[1 1 1])
%text(ax1,2110,0.25,'OG POST','FontSize',12,'FontName','Arial')
text(ax1,2110,0.5,'TM P','FontSize',12,'FontName','Arial','Color',[0 0 0])
