...
%timeCourse OG post
ax3a = axes('Position',[left+0.04  lower+delta width2*1.5 height],'XTickLabel',{''},'Clipping','off','XLim',[0 35],'YLim',[-0.025 0.25],'YTick',[0 0.1 0.2 0.3],'FontSize',12,'FontName','Arial');
ax3b = axes('Position',[left+0.04+width2*1.5+0.04  lower+delta width2*1.5 height],'XTickLabel',{''},'Clipping','off','XLim',[0 35],'YLim',[-0.025 0.25],'YTick',[0 0.1 0.2 0.3],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
%ax3c = axes('Position',[left+2*(width2+0.04)  lower+delta width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0 35],'YLim',[-0.025 0.25],'YTick',[0 0.1 0.2 0.3],'YTickLabel',{''},'FontSize',12,'FontName','Arial');

%bar plots OG post
ax4a = axes('Position',[left+0.04  lower width2*1.5 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.025 0.25],'YTick',[0 0.1 0.2],'FontSize',12,'FontName','Arial');
ax4b = axes('Position',[left+0.04+width2*1.5+0.04  lower width2*1.5 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.025 0.25],'YTick',[0 0.1 0.2],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
...
errorbar(ax2a,4,nanmean(TFullAbruptTM.maxError),nanstd(TFullAbruptTM.maxError)./sqrt(length(TFullAbruptTM.maxError)),...
    'Color','k','LineWidth',2)
plot(ax2a,[2.5 2.5],[-0.35 0],'--k','Color',[0.6 0.6 0.6],'LineWidth',2)
...
errorbar(ax2b,4,nanmean(TFullAbruptTM.meanError),nanstd(TFullAbruptTM.meanError)./sqrt(length(TFullAbruptTM.meanError)),...
    'Color','k','LineWidth',2)
plot(ax2b,[2.5 2.5],[-0.35 0],'--k','Color',[0.6 0.6 0.6],'LineWidth',2)
...
errorbar(ax2c,4,nanmean(TFullAbruptTM.netContributionNorm2_lateAdapt),nanstd(TFullAbruptTM.netContributionNorm2_lateAdapt)./sqrt(length(TFullAbruptTM.netContributionNorm2_lateAdapt)),...
    'Color','k','LineWidth',2)
plot(ax2c,[2.5 2.5],[-0.35 0],'--k','Color',[0.6 0.6 0.6],'LineWidth',2)
...
for g=1:4
    ...
    if g<3
        ...
        dt5=TC{g}.OGpSP(:,26:35);
        dt6=TC{g}.OGpST(:,26:35);
        ...
        patch(ax3b,[1:20 fliplr(1:20)],[nanmean(dt1)+(nanstd(dt1)./sqrt(ns)) fliplr(nanmean(dt1)-(nanstd(dt1)./sqrt(ns)))],[1 1 1],'FaceAlpha',0,'EdgeColor',colors(g,:))
        ...
        patch(ax3b,[26:35 fliplr(26:35)],[nanmean(dt4)+(nanstd(dt4)./sqrt(ns)) fliplr(nanmean(dt4)-(nanstd(dt4)./sqrt(ns)))],[1 1 1],'FaceAlpha',0,'EdgeColor',colors(g,:))
        ...
        plot(ax3b,1:35,nanmean(TC{g}.TMpNet),'ok','MarkerFaceColor',[1 1 1],'MarkerEdgeColor',colors(g,:),'MarkerSize',4)  
...
ylabel(ax3a,'stepAsym')
text(ax3a,-9,0.32,'B','FontSize',20,'FontName','Arial','FontWeight','Bold')
text(ax3a,22.5,0.32,'Aftereffects','FontSize',14,'FontName','Arial')
text(ax3a,5,0.26,'Overground','FontSize',12,'FontName','Arial');
text(ax3b,10,0.26,'Treadmill','FontSize',12,'FontName','Arial');
% text(ax3c,2,0.26,'stepTime','FontSize',12,'FontName','Arial');
plot(ax3b,[26 35],[-0.03 -0.03],'k','LineWidth',2)
text(ax3b,26,-0.05,'10 srides','FontName','Arial','FontSize',10);
...
errorbar(ax4a,2,nanmean(TFullAbrupt.netContributionNorm2_OG_P),nanstd(TFullAbrupt.netContributionNorm2_OG_P)./sqrt(length(TFullAbrupt.netContributionNorm2_OG_P)),...
    'Color','k','LineWidth',2)
bar(ax4a,3,nanmean(TControl.netContributionNorm2_OG_LP),'FaceColor',[0.2 0.2 1],'BarWidth',0.7);
errorbar(ax4a,3,nanmean(TControl.netContributionNorm2_OG_LP),nanstd(TControl.netContributionNorm2_OG_LP)./sqrt(length(TControl.netContributionNorm2_OG_LP)),...
    'Color','k','LineWidth',2)
bar(ax4a,4,nanmean(TFullAbrupt.netContributionNorm2_OG_LP),'FaceColor',[0.8 0 0],'BarWidth',0.7);
errorbar(ax4a,4,nanmean(TFullAbrupt.netContributionNorm2_OG_LP),nanstd(TFullAbrupt.netContributionNorm2_OG_LP)./sqrt(length(TFullAbrupt.netContributionNorm2_OG_LP)),...
    'Color','k','LineWidth',2)

ylabel(ax4a,'stepAsym')
text(ax4a,1,0.26,'Overground','FontSize',12,'FontName','Arial');
plot(ax4a,[1 3],[0.16 0.16],'-k','LineWidth',2)
plot(ax4a,[2 4],[0.14 0.14],'-k','LineWidth',2)
text(ax4a,1,-0.05,'Early','FontSize',12,'FontName','Arial')
text(ax4a,3,-0.05,'Late','FontSize',12,'FontName','Arial')

hold(ax4b)%control and small errors
bar(ax4b,1,nanmean(TControlTM.spatialContributionNorm2_TM_P),'EdgeColor',[0.2 0.2 1],'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax4b,1,nanmean(TControlTM.spatialContributionNorm2_TM_P),nanstd(TControlTM.spatialContributionNorm2_TM_P)./sqrt(length(TControlTM.spatialContributionNorm2_TM_P)),...
    'Color','k','LineWidth',2)
bar(ax4b,2,nanmean(TFullAbruptTM.spatialContributionNorm2_TM_P),'EdgeColor',[0.8 0 0],'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax4b,2,nanmean(TFullAbruptTM.spatialContributionNorm2_TM_P),nanstd(TFullAbruptTM.spatialContributionNorm2_TM_P)./sqrt(length(TFullAbruptTM.spatialContributionNorm2_TM_P)),...
    'Color','k','LineWidth',2)
bar(ax4b,3,nanmean(TControlTM.spatialContributionNorm2_TM_LP),'EdgeColor',[0.2 0.2 1],'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax4b,3,nanmean(TControlTM.spatialContributionNorm2_TM_LP),nanstd(TControlTM.spatialContributionNorm2_TM_LP)./sqrt(length(TControlTM.spatialContributionNorm2_TM_LP)),...
    'Color','k','LineWidth',2)
bar(ax4b,4,nanmean(TFullAbruptTM.spatialContributionNorm2_TM_LP),'EdgeColor',[0.8 0 0],'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax4b,4,nanmean(TFullAbruptTM.spatialContributionNorm2_TM_LP),nanstd(TFullAbruptTM.spatialContributionNorm2_TM_LP)./sqrt(length(TFullAbruptTM.spatialContributionNorm2_TM_LP)),...
    'Color','k','LineWidth',2)

text(ax4b,1.2,0.26,'Treadmill','FontSize',12,'FontName','Arial');
plot(ax4b,[1 3],[0.2 0.2],'-k','LineWidth',2)
plot(ax4b,[2 4],[0.18 0.18],'-k','LineWidth',2)
text(ax4b,1,-0.05,'Early','FontSize',12,'FontName','Arial')
text(ax4b,3,-0.05,'Late','FontSize',12,'FontName','Arial')
...
ax2c = axes('Position',[left+2*(width2+0.04)  lower+2*delta+0.07 width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[-0.25 0],'YTick',[-0.2 -0.1 0],'YTickLabel',{''},'FontSize',12,'FontName','Arial');

%timeCourse TM post
ax3a = axes('Position',[left+0.04  lower+delta width2*1.5 height],'XTickLabel',{''},'Clipping','off','XLim',[0 20],'YLim',[0 0.25],'YTick',[0 0.1 0.2],'FontSize',12,'FontName','Arial');
ax3b = axes('Position',[left+0.04+width2*1.5+0.04  lower+delta width2*1.5 height],'XTickLabel',{''},'Clipping','off','XLim',[0 20],'YLim',[0 0.25],'YTick',[0 0.1 0.2],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
...
errorbar(ax2a,4,nanmean(TFullAbruptTM.maxErrorReadapt),nanstd(TFullAbruptTM.maxErrorReadapt)./sqrt(length(TFullAbruptTM.maxErrorReadapt)),...
    'Color','k','LineWidth',2)
plot(ax2a,[2.5 2.5],[-0.25 0],'--k','Color',[0.6 0.6 0.6],'LineWidth',2)
...
errorbar(ax2b,4,nanmean(TFullAbruptTM.meanErrorReadapt),nanstd(TFullAbruptTM.meanErrorReadapt)./sqrt(length(TFullAbruptTM.meanErrorReadapt)),...
    'Color','k','LineWidth',2)
plot(ax2b,[2.5 2.5],[-0.25 0],'--k','Color',[0.6 0.6 0.6],'LineWidth',2)
text(ax2b,0.5,0.03,'Mean Error','FontSize',12,'FontName','Arial');
...
errorbar(ax2c,4,nanmean(TFullAbruptTM.netContributionNorm2_lateReadapt),nanstd(TFullAbruptTM.netContributionNorm2_lateReadapt)./sqrt(length(TFullAbruptTM.netContributionNorm2_lateReadapt)),...
    'Color','k','LineWidth',2)
plot(ax2c,[2.5 2.5],[-0.25 0],'--k','Color',[0.6 0.6 0.6],'LineWidth',2)
text(ax2c,0.5,0.03,'Late Error','FontSize',12,'FontName','Arial');
...
for g=1:4
    ...
    if g>2
        ...
        plot(ax3b,1:20,nanmean(TC{g}.OGpNet(:,1:20)),'ok','MarkerFaceColor',[1 1 1],'MarkerEdgeColor',colors(g,:),'MarkerSize',4)  
        %plot(ax3b,1:35,nanmean(TC{g}.OGpSP),'ok','MarkerFaceColor',colors(g,:),'MarkerEdgeColor',colors2(g,:),'MarkerSize',4)
        %plot(ax3c,1:35,nanmean(TC{g}.OGpST),'ok','MarkerFaceColor',colors(g,:),'MarkerEdgeColor',colors2(g,:),'MarkerSize',4)  
    else
        dt1=TC{g}.TMpNet(:,1:20);
...
ylabel(ax3a,'stepAsym')
text(ax3a,-9,0.32,'B','FontSize',20,'FontName','Arial','FontWeight','Bold')
text(ax3a,15,0.32,'Aftereffects','FontSize',14,'FontName','Arial')
text(ax3b,3,0.26,'Overground','FontSize',12,'FontName','Arial');
text(ax3a,8,0.26,'Treadmill','FontSize',12,'FontName','Arial');
% text(ax3c,2,0.26,'stepTime','FontSize',12,'FontName','Arial');
plot(ax3b,[10 20],[-0.03 -0.03],'k','LineWidth',2)
text(ax3b,10,-0.05,'10 srides','FontName','Arial','FontSize',10);
% 
