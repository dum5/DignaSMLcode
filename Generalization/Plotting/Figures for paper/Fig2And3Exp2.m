...
for g=1:4
    if g==1 || g==3
        ...
        TC{g}.prepertNet=smoothData(timeCourseUnbiased{Inds(g)}.param{4}.cond{5}(1:150,:),binWidth)';%preperturbation
        TC{g}.adaptNet=smoothData(timeCourseUnbiased{Inds(g)}.param{4}.cond{6}(1:900,:),binWidth)';%adaptation
    end
