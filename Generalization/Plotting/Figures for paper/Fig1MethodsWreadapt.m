...
ymax=1650;
%tiedcol=[0.7 0.7 0.7];
splitcol=[0.7 0.7 0.7];
GeneralizationColorMap;
ColFeedback=[0.4 0.4 0.4];
...
catchPert1=[linspace(1.125,1.5,40) 1.5*ones(1,555) NaN(1,5) 1.125*ones(1,10) NaN(1,5) 1.5*ones(1,285)];
catchPert2=[linspace(1.125,0.75,40) 0.75*ones(1,555) NaN(1,5) 1.125*ones(1,10) NaN(1,5) 0.75*ones(1,285)];
...
%     patch(ax(a),[x2(1),x2(end),x2(end),x2(1)],[1.75 1.75 0.5 0.5],tiedcol,'FaceAlpha',0.5,'LineStyle','none')
    if a==6
        patch(ax(a),[x3(1),x3(595),x3(595),x3(1)],[1.75 1.75 0.5 0.5],splitcol,'FaceAlpha',0.5,'LineStyle','none')
        patch(ax(a),[x3(616),x3(end),x3(end),x3(616)],[1.75 1.75 0.5 0.5],splitcol,'FaceAlpha',0.5,'LineStyle','none')
    else
        patch(ax(a),[x3(1),x3(end),x3(end),x3(1)],[1.75 1.75 0.5 0.5],splitcol,'FaceAlpha',0.5,'LineStyle','none')
    end
    if a==1 || a>2
        patch(ax(a),[x5(1),x5(end),x5(end),x5(1)],[1.75 1.75 0.5 0.5],splitcol,'FaceAlpha',0.5,'LineStyle','none')
    else
        hs=patch(ax(a),[x5(1),x5(end),x5(end),x5(1)],[1.75 1.75 0.5 0.5],[1 1 1],'FaceAlpha',0.5,'LineStyle','none');
        hatchfill2(hs)
    end
%     if a==4
...
text(ax(1),x3(1)+75,2.2,'A.   Experiment 1','FontSize',14,'FontName','Arial','FontWeight','Bold')
text(ax(1),-10,1.9,'OGB','FontSize',9,'FontName','Arial','FontWeight','Bold')
text(ax(1),x2(20),1.9,'TMB','FontSize',9,'FontName','Arial','FontWeight','Bold')
text(ax(1),mean(x3)*0.75,1.9,'Adap1','FontWeight','Bold')
text(ax(1),x4(1),1.9,'OGP','FontSize',9,'FontName','Arial','FontWeight','Bold')
text(ax(1),x5(1)+75,1.9,'Adap2','FontWeight','Bold')
text(ax(1),x6(1),1.9,'TMP','FontSize',9,'FontName','Arial','FontWeight','Bold')
...
% gradual
text(ax(2),-10,1.9,'OGB','FontSize',9,'FontName','Arial','FontWeight','Bold')
text(ax(2),x2(20),1.9,'TMB','FontSize',9,'FontName','Arial','FontWeight','Bold')
text(ax(2),mean(x3)*0.75,1.9,'Adap1','FontWeight','Bold')
text(ax(2),x4(1),1.9,'OGP','FontSize',9,'FontName','Arial','FontWeight','Bold')
text(ax(2),x5(1)+75,1.9,'Adap2','FontWeight','Bold')
text(ax(2),x6(1),1.9,'TMP','FontSize',9,'FontName','Arial','FontWeight','Bold')
...
text(ax(3),x3(1)+75,2,'B.   Experiment 2','FontSize',14,'FontName','Arial','FontWeight','Bold')
...
plot(ax(4),[x4(1) x4(end)],[1.125 1.125],'Color',ColControl,'LineWidth',3,'LineStyle',':')
plot(ax(4),[x4(1) x4(end)],[1.125 1.125]+offset,'Color',ColFullAbrupt,'LineWidth',3,'LineStyle',':')
a1=text(ax(4),x4(1),1.9,'TMP','FontSize',9,'FontName','Arial','FontWeight','Bold');
a2=text(ax(4),x6(1),1.9,'OGP','FontSize',9,'FontName','Arial','FontWeight','Bold');
...
%control catch
text(ax(5),x3(1)+75,2,'C.   Experiment 3','FontSize',14,'FontName','Arial','FontWeight','Bold')
text(ax(5),x3(1)+75,0.2,'D.   Visual Feedback','FontSize',14,'FontName','Arial','FontWeight','Bold')

plot(ax(5),[x2,x3],[tied,rampPert1],'Color',ColControl,'LineWidth',3)
plot(ax(5),[x2,x3],[tied,rampPert2],'Color',ColControl,'LineWidth',3)
plot(ax(6),[x2,x3],[tied,catchPert1]+offset,'Color',ColCatch,'LineWidth',3)
plot(ax(6),[x2,x3],[tied,catchPert2]+offset,'Color',ColCatch,'LineWidth',3)
...
plot(ax(6),[x5],readap1+offset,'Color',ColCatch,'LineWidth',3)
plot(ax(6),[x5],readap2+offset,'Color',ColCatch,'LineWidth',3)
plot(ax(6),[x6],washout+offset,'Color',ColCatch,'LineWidth',3)

text(ax(5),320, 1.25,'Control','FontSize',12,'FontName','Arial','Color',ColControl,'FontWeight','bold')
text(ax(6),320, 1.25,'Catch','FontSize',12,'FontName','Arial','Color',ColCatch,'FontWeight','bold')

plot(ax(5),[x2(1) x2(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(5),[x3(1) x3(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(5),[x4(1) x4(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(5),[x5(1) x5(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(5),[x6(1) x6(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',2)

plot(ax(6),[x2(1) x2(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(6),[x3(1) x3(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(6),[x4(1) x4(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(6),[x5(1) x5(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
plot(ax(6),[x6(1) x6(1)],[0.5 5.55],'--k','Color',[0.5 0.5 0.5],'LineWidth',1)
