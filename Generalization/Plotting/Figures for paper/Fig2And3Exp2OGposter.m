...
%timeCourse OG post
ax3a = axes('Position',[left+width4-0.11  lower+delta+0.04 width3+0.18 height/0.9],'XTickLabel',{''},'Clipping','off','XLim',[0 35],'YLim',[0 0.12],'YTick',[0 0.1 0.2 0.3],'FontSize',12,'FontName','Arial');

%bar plots OG post
ax4a = axes('Position',[left+width4-0.11  lower width2+0.04 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 4.5],'YLim',[0 0.2],'YTick',[0 0.1 0.2 0.3],'FontSize',12,'FontName','Arial');
ax4b = axes('Position',[left+width4-0.11+(width2+0.09)  lower width2-0.04 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 2.5],'YLim',[0 0.2],'YTick',[0 0.1 0.2 0.3],'FontSize',12,'FontName','Arial');
...
text(ax1,680,-0.10,'Control','Color',colors(1,:),'FontName','Arial','FontSize',12,'FontWeight','bold')
text(ax1,680,-0.14,'Abrupt','Color',colors(2,:),'FontName','Arial','FontSize',12,'FontWeight','bold')
...
hold(ax2a)
bar(ax2a,1,nanmean(TControl.maxError),'FaceColor',[0.2 0.2 1],'BarWidth',0.5);
errorbar(ax2a,1,nanmean(TControl.maxError),nanstd(TControl.maxError)./sqrt(length(TControl.maxError)),...
    'Color','k','LineWidth',2)
bar(ax2a,2,nanmean(TFullAbrupt.maxError),'FaceColor',[0.8 0 0],'BarWidth',0.5);
...
bar(ax2c,1,nanmean(TControl.netContributionNorm2_lateAdapt),'FaceColor',[0.2 0.2 1],'BarWidth',0.5);
errorbar(ax2c,1,nanmean(TControl.netContributionNorm2_lateAdapt),nanstd(TControl.netContributionNorm2_lateAdapt)./sqrt(length(TControl.netContributionNorm2_lateAdapt)),...
    'Color','k','LineWidth',2)
bar(ax2c,2,nanmean(TFullAbrupt.netContributionNorm2_lateAdapt),'FaceColor',[0.8 0 0],'BarWidth',0.5);
...
hold(ax4b)
bar(ax4b,1,nanmean(TControl.netContributionNorm2_deltaOG),'FaceColor',[0.2 0.2 1],'BarWidth',0.7);
errorbar(ax4b,1,nanmean(TControl.netContributionNorm2_deltaOG),nanstd(TControl.netContributionNorm2_deltaOG)./sqrt(length(TControl.netContributionNorm2_deltaOG)),...
    'Color','k','LineWidth',2)
bar(ax4b,2,nanmean(TFullAbrupt.netContributionNorm2_deltaOG),'FaceColor',[0.8 0 0],'BarWidth',0.7);
errorbar(ax4b,2,nanmean(TFullAbrupt.netContributionNorm2_deltaOG),nanstd(TFullAbrupt.netContributionNorm2_deltaOG)./sqrt(length(TFullAbrupt.netContributionNorm2_deltaOG)),...
    'Color','k','LineWidth',2)


%ylabel(ax4a,'stepAsym')
text(ax3a,7,0.12,'OG post','FontSize',14,'FontName','Arial')
...
%Errors
ax2a = axes('Position',[left  lower width2*1.25 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 2.5],'YLim',[-0.1 0],'YTick',[-0.2 -0.1 0],'FontSize',12,'FontName','Arial');
...
ax2c = axes('Position',[left+(width2*1.2+0.08)  lower width2*1.25 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 2.5],'YLim',[-0.1 0],'YTick',[-0.2 -0.1 0],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
...
text(ax1,50,-0.075,'Control','Color',colors(1,:),'FontName','Arial','FontSize',12,'FontWeight','bold')
text(ax1,50,-0.105,'Abrupt','Color',colors(2,:),'FontName','Arial','FontSize',12,'FontWeight','bold')
...
errorbar(ax2a,1,nanmean(TControl.maxErrorReadapt),nanstd(TControl.maxErrorReadapt)./sqrt(length(TControl.maxErrorReadapt)),...
    'Color','k','LineWidth',2)
bar(ax2a,2,nanmean(TFullAbrupt.maxErrorReadapt),'FaceColor',[0.8 0 0],'BarWidth',0.5);
...
errorbar(ax2c,1,nanmean(TControl.netContributionNorm2_lateReadapt),nanstd(TControl.netContributionNorm2_lateReadapt)./sqrt(length(TControl.netContributionNorm2_lateReadapt)),...
    'Color','k','LineWidth',2)
bar(ax2c,2,nanmean(TFullAbrupt.netContributionNorm2_lateReadapt),'FaceColor',[0.8 0 0],'BarWidth',0.5);
...
% text(ax3c,2,0.26,'stepTime','FontSize',12,'FontName','Arial');
text(ax3a,7,0.17,'TM post','FontSize',14,'FontName','Arial')
plot(ax3a,[10 20],[-0.03 -0.03],'k','LineWidth',2)
text(ax3a,10,-0.05,'10 srides','FontName','Arial','FontSize',10);
% 
...
errorbar(ax4a,1,nanmean(TControl.netContributionNorm2_TM_P),nanstd(TControl.netContributionNorm2_TM_P)./sqrt(length(TControl.netContributionNorm2_TM_P)),...
    'Color','k','LineWidth',2)
bar(ax4a,2,nanmean(TFullAbrupt.netContributionNorm2_TM_P),'FaceColor',[0.8 0 0],'BarWidth',0.5);
