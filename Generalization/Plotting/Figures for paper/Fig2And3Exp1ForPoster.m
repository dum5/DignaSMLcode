...
ax1 = axes('Position',[left  lower+delta+0.04 width4 height/0.9],'XTickLabel',{''},'Clipping','off','XLim',[0 930],'YLim',[-0.2 0.05],'YTick',[-0.2 0 0.2],'XTick',[0 100 200 300 400 500 600 700 800 900],'FontSize',12,'FontName','Arial');
%Errors
ax2a = axes('Position',[left  lower width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 3.5],'YLim',[-0.2 0],'YTick',[-0.2 -0.1 0],'FontSize',12,'FontName','Arial');
ax2b = axes('Position',[left+width2+0.04 lower  width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 3.5],'YLim',[-0.2 0],'YTick',[-0.2 -0.1 0],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
ax2c = axes('Position',[left+2*(width2+0.04) lower width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 3.5],'YLim',[-0.2 0],'YTick',[-0.2 -0.1 0],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
...
% %bar plots OG post
ax4a = axes('Position',[left+width4+0.07  lower width3 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 3.5],'YLim',[0 0.15],'YTick',[0 0.1],'FontSize',12,'FontName','Arial');
...
text(ax1,200,l(2)-0.02+0.03,'Adaptation Errors','FontSize',14,'FontName','Arial')
for g=1:3
...
text(ax1,680,-0.14,'Small Explicit','Color',colors(2,:),'FontName','Arial','FontSize',12,'FontWeight','bold')
text(ax1,680,-0.18,'Small Implicit','Color',colors(3,:),'FontName','Arial','FontSize',12,'FontWeight','bold')
plot(ax1,[300 400],[-0.22 -0.22],'k','LineWidth',2)
text(ax1,300,-0.18,'100 srides','FontName','Arial','FontSize',10);
...
text(ax3a,7,0.17,'OG post','FontSize',14,'FontName','Arial')
...
plot(ax3a,[10 20],[-0.01 -0.01],'k','LineWidth',2,'Clipping','off')
text(ax3a,10,-0.02,'10 srides','FontName','Arial','FontSize',10,'Clipping', 'off');


hold(ax4a)%control and small errors
bar(ax4a,1,nanmean(TControl.netContributionNorm2_OG_P),'FaceColor',[0.2 0.2 1],'BarWidth',0.6);
errorbar(ax4a,1,nanmean(TControl.netContributionNorm2_OG_P),nanstd(TControl.netContributionNorm2_OG_P)./sqrt(length(TControl.netContributionNorm2_OG_P)),...
    'Color','k','LineWidth',2)
bar(ax4a,2,nanmean(TFeedback.netContributionNorm2_OG_P),'FaceColor',[0.6 0.6 0.6],'BarWidth',0.6);
errorbar(ax4a,2,nanmean(TFeedback.netContributionNorm2_OG_P),nanstd(TFeedback.netContributionNorm2_OG_P)./sqrt(length(TFeedback.netContributionNorm2_OG_P)),...
    'Color','k','LineWidth',2)
bar(ax4a,3,nanmean(TGradual.netContributionNorm2_OG_P),'FaceColor',[0.6 0 0.6],'BarWidth',0.6);
...
%ax2b = axes('Position',[left+width2+0.04  lower width2 height],'XTickLabel',{''},'Clipping','off','XLim',[0.5 2.5],'YLim',[-0.1 0],'YTick',[-0.2 -0.1 0],'YTickLabel',{''},'FontSize',12,'FontName','Arial');
...
text(ax1,50,-0.105,'Small Explicit','Color',colors(2,:),'FontName','Arial','FontSize',12,'FontWeight','bold')
...
errorbar(ax2a,1,nanmean(TControl.maxErrorReadapt),nanstd(TControl.maxErrorReadapt)./sqrt(length(TControl.maxErrorReadapt)),...
    'Color','k','LineWidth',2)
bar(ax2a,2,nanmean(TFeedback.maxErrorReadapt),'FaceColor',[0.6 0.6 0.6],'BarWidth',0.5);
...
errorbar(ax2c,1,nanmean(TControl.netContributionNorm2_lateReadapt),nanstd(TControl.netContributionNorm2_lateReadapt)./sqrt(length(TControl.netContributionNorm2_lateReadapt)),...
    'Color','k','LineWidth',2)
bar(ax2c,2,nanmean(TFeedback.netContributionNorm2_lateReadapt),'FaceColor',[0.6 0.6 0.6],'BarWidth',0.5);
...
errorbar(ax4a,1,nanmean(TControl.netContributionNorm2_TM_P),nanstd(TControl.netContributionNorm2_TM_P)./sqrt(length(TControl.netContributionNorm2_TM_P)),...
    'Color','k','LineWidth',2)
bar(ax4a,2,nanmean(TFeedback.netContributionNorm2_TM_P),'FaceColor',[0.6 0.6 0.6],'BarWidth',0.5);
