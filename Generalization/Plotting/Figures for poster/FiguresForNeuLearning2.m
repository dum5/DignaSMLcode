...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Experiment 2: control, catch %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%initialize figure
f2=figure('Name','Experiment 2');
set(f2,'Color',[1 1 1]','Units','inches','Position',[0 0 10 5]);
...
%     'Color','k','LineWidth',2)
bar(ax1,2,nanmean(TCatch.maxError),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax1,2,nanmean(TCatch.maxError),nanstd(TCatch.maxError)./sqrt(length(TCatch.maxError)),...
    'Color','k','LineWidth',2)
bar(ax1,3,nanmean(TCatch.netContributionNorm2_catch),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax1,3,nanmean(TCatch.netContributionNorm2_catch),nanstd(TCatch.netContributionNorm2_catch)./sqrt(length(TCatch.netContributionNorm2_catch)),...
    'Color','k','LineWidth',2)
bar(ax1,4,nanmean(TCatch.netContributionNorm2_resumeSplit),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax1,4,nanmean(TCatch.netContributionNorm2_resumeSplit),nanstd(TCatch.netContributionNorm2_resumeSplit)./sqrt(length(TCatch.netContributionNorm2_resumeSplit)),...
    'Color','k','LineWidth',2)
plot(ax1,[2.5 2.5],[-0.4 0.4],'--k','LineWidth',2,'Color',[0.5 0.5 0.5])
...
set(ax1,'XLim',[0.5 4.5],'XTickLabel',{''},'YTick',[-0.4 -0.2 0 0.2 0.4])
...
%     'Color','k','LineWidth',2)
bar(ax2,2,nanmean(TCatch.netContributionNorm2_OG_P),'FaceColor',[0.67 0.85 0.30],'BarWidth',0.7);
errorbar(ax2,2,nanmean(TCatch.netContributionNorm2_OG_P),nanstd(TCatch.netContributionNorm2_OG_P)./sqrt(length(TCatch.netContributionNorm2_OG_P)),...
    'Color','k','LineWidth',2)
plot(ax2,[1 2],[0.125 0.125],'Color','k','LineWidth',2)
set(ax2,'XLim',[0.5 2.5],'XTickLabel',{''},'YLim',[0 0.15],'YTick',[0 0.05 0.1 0.15])
ylabel(ax2,'After Effect Overground','FontWeight','Bold','FontSize',20)
ll=flipud(findobj(ax2,'Type','Bar'));
legend(ax2,ll,{'Control','Catch'},'Position',[0.80 0.80 0.17 0.16],'box','off')
...
set(f3,'Color',[1 1 1]','Units','inches','Position',[0 0 10 5])
ax1 = axes('Position',[0.1   0.15   0.35 0.73],'FontSize',16);
...
bar(ax1,3,nanmean(TTMAbruptNoFeedback.maxError),'EdgeColor',[0.2 0.2 1],'LineWidth',2,'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax1,3,nanmean(TTMAbruptNoFeedback.maxError),nanstd(TTMAbruptNoFeedback.maxError)./sqrt(length(TTMAbruptNoFeedback.maxError)),...
    'Color','k','LineWidth',2)

bar(ax1,4,nanmean(TTMFullAbrupt.maxError),'EdgeColor',[0.8 0 0],'LineWidth',2,'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax1,4,nanmean(TTMFullAbrupt.maxError),nanstd(TTMFullAbrupt.maxError)./sqrt(length(TTMFullAbrupt.maxError)),...
    'Color','k','LineWidth',2)


set(ax1,'XLim',[0.5 4.5],'XTickLabel',{''},'YTick',[-0.3 -0.2 -0.1 0])
ylabel(ax1,'Maximum Error Adaptation','FontWeight','Bold','FontSize',20)

plot(ax1,[1 2],[-0.32 -0.32],'Color','k','LineWidth',2)
plot(ax1,[3 4],[-0.32 -0.32],'Color','k','LineWidth',2)
...
bar(ax2,3,nanmean(TTMAbruptNoFeedback.netContributionNorm2_TM_P),'EdgeColor',[0.2 0.2 1],'LineWidth',2,'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax2,3,nanmean(TTMAbruptNoFeedback.netContributionNorm2_TM_P),nanstd(TTMAbruptNoFeedback.netContributionNorm2_TM_P)./sqrt(length(TTMAbruptNoFeedback.netContributionNorm2_TM_P)),...
    'Color','k','LineWidth',2)

bar(ax2,4,nanmean(TTMFullAbrupt.netContributionNorm2_TM_P),'EdgeColor',[0.8 0 0],'LineWidth',2,'FaceColor',[1 1 1],'BarWidth',0.7);
errorbar(ax2,4,nanmean(TTMFullAbrupt.netContributionNorm2_TM_P),nanstd(TTMFullAbrupt.netContributionNorm2_TM_P)./sqrt(length(TTMFullAbrupt.netContributionNorm2_TM_P)),...
    'Color','k','LineWidth',2)
ll=flipud(findobj(ax2,'Type','Bar'));
legend(ax2,ll,{'Control (OG post)','Abrupt Pert (OM post)','Control (TM post)','Abrupt pert (TM post)'},'Position',[0.75 0.80 0.17 0.16],'box','off')

set(ax2,'XLim',[0.5 4.5],'XTickLabel',{''},'YTick',[0 0.1 0.2 0.3])
ylabel(ax2,'After Effect','FontWeight','Bold','FontSize',20)
%initialize figure
lower=0.07;
height=0.09;
width=0.95;
...
f5=figure('Name','Adaptation Protocols');
set(f5,'Color',[1 1 1]','Units','inches','Position',[0 0 10 10])
ax1 = axes('Position',[0.1 lower+3*delta width height],'XTickLabel',{''},'YTick',[-0.2 0 0.2],'XLim',[0 ymax2],'YLim',[yaxmin yaxmax],'FontSize',14);
ax2 = axes('Position',[0.1 lower+2*delta width height],'XTickLabel',{''},'YTick',[-0.2 0 0.2],'XLim',[0 ymax2],'YLim',[yaxmin yaxmax],'FontSize',14);
ax3 = axes('Position',[0.1 lower+1*delta width height],'XTickLabel',{''},'YTick',[-0.2 0 0.2],'XLim',[0 ymax2],'YLim',[yaxmin yaxmax],'FontSize',14);
ax4 = axes('Position',[0.1 lower width height],'YTick',[-0.2 0 0.2],'XLim',[0 ymax2],'YLim',[yaxmin yaxmax],'FontSize',14);

% ax2 = axes('Position',[0.05  lower+5*delta width height],'XTickLabel',{''},'YTickLabel',{''},'Clipping','off','XLim',[0 ymax2],'YLim',[-0.3 0.3],'YTick',[0 100]);
% ax3 = axes('Position',[0.05 lower+4*delta width height],'XTickLabel',{''},'YTickLabel',{''},'Clipping','off','XLim',[0 ymax2],'YLim',[-0.3 0.3],'YTick',[0 100]);
% ax4 = axes('Position',[0.05  lower+3*delta width height],'XTickLabel',{''},'YTickLabel',{''},'Clipping','off','XLim',[0 ymax2],'YLim',[-0.3 0.3],'YTick',[0 100]);
% ax5 = axes('Position',[0.05  lower+2*delta width height],'XTickLabel',{''},'YTickLabel',{''},'Clipping','off','XLim',[0 ymax2],'YLim',[-0.3 0.3],'YTick',[0 100]);
% ax6 = axes('Position',[0.05  lower+delta width height],'XTickLabel',{''},'YTickLabel',{''},'Clipping','off','XLim',[0 ymax2],'YLim',[-0.3 0.3],'YTick',[0 100]);
% ax7 = axes('Position',[0.05 lower width height],'XTickLabel',{''},'YTickLabel',{''},'Clipping','off','XLim',[0 ymax2],'YLim',[-0.3 0.3],'YTick',[0 100]);

hold(ax1)%control and small errors
patch(ax1,[tmInd,fliplr(tmInd)],[yaxmin*ones(1,length(tmInd)) yaxmax*ones(1,length(tmInd))],[0.9 0.9 0.9],'FaceAlpha',0.5,'LineStyle','none')
dt.og=timeCourseUnbiased{3}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{3}.param{4}.cond{6}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{3}.param{4}.cond{6}(length(x2)+1:length(x2)+length(x3),:)';
dt.wash=timeCourseUnbiased{3}.param{4}.cond{7}(1:length(x4),:)';
%dt.all=[dt.og dt.prepert dt.adapt dt.wash];
dt.all=[dt.prepert(:,end-49:end) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax1,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.2 0.2 1])
patch(ax1,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.2 0.2 1],'FaceAlpha',0.5,'LineStyle','none')
clear dt
dt.og=timeCourseUnbiased{1}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{1}.param{4}.cond{6}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{1}.param{4}.cond{6}(length(x2)+1:length(x2)+length(x3),:)';
dt.wash=timeCourseUnbiased{1}.param{4}.cond{7}(1:length(x4),:)';
%dt.all=[dt.og dt.prepert dt.adapt dt.wash];
dt.all=[dt.prepert(:,end-49:end) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax1,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.6 0 0.6])
patch(ax1,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.6 0 0.6],'FaceAlpha',0.5,'LineStyle','none')
clear dt
dt.og=timeCourseUnbiased{4}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{4}.param{4}.cond{6}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{4}.param{4}.cond{6}(length(x2)+1:length(x2)+length(x3),:)';
dt.wash=timeCourseUnbiased{4}.param{4}.cond{7}(1:length(x4),:)';
%dt.all=[dt.og dt.prepert dt.adapt dt.wash];
dt.all=[dt.prepert(:,end-49:end) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax1,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.6 0.6 0.6])
patch(ax1,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.6 0.6 0.6],'FaceAlpha',0.5,'LineStyle','none')
clear dt

hold(ax2)%control and catch
patch(ax2,[tmInd,fliplr(tmInd)],[yaxmin*ones(1,length(tmInd)) yaxmax*ones(1,length(tmInd))],[0.9 0.9 0.9],'FaceAlpha',0.5,'LineStyle','none')
dt.og=timeCourseUnbiased{3}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{3}.param{4}.cond{6}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{3}.param{4}.cond{6}(length(x2)+1:length(x2)+length(x3),:)';
dt.wash=timeCourseUnbiased{3}.param{4}.cond{7}(1:length(x4),:)';
...
dt.all=[dt.prepert(:,end-49:end) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax2,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.2 0.2 1])
patch(ax2,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.2 0.2 1],'FaceAlpha',0.5,'LineStyle','none')
clear dt
dt.og=timeCourseUnbiased{5}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{5}.param{4}.cond{6}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{5}.param{4}.cond{6}(length(x2)+1:length(x2)+length(x3),:)';
dt.wash=timeCourseUnbiased{5}.param{4}.cond{7}(1:length(x4),:)';
[catchError]=getGroupedTimeCourses(groups(5),{'Catch'},{'netContributionNorm2'});
TMbias=squeeze(groupOutcomes{5}(4,TMref,:))'; 
dt.catch=[catchError{1}.param{1}.cond{1}-TMbias]';
dt.all=[dt.prepert(:,end-49:end) dt.adapt(:,1:590) dt.catch(:,1:10) dt.adapt(:,601:880) dt.wash(:,1:20)];
plot(ax2,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.67 0.85 0.30])
patch(ax2,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.67 0.85 0.30],'FaceAlpha',0.5,'LineStyle','none')



hold(ax3)%control and full abrupt
patch(ax3,[tmInd,fliplr(tmInd)],[yaxmin*ones(1,length(tmInd)) yaxmax*ones(1,length(tmInd))],[0.9 0.9 0.9],'FaceAlpha',0.5,'LineStyle','none')
dt.og=timeCourseUnbiased{3}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{3}.param{4}.cond{6}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{3}.param{4}.cond{6}(length(x2)+1:length(x2)+length(x3),:)';
dt.wash=timeCourseUnbiased{3}.param{4}.cond{7}(1:length(x4),:)';
...
dt.all=[dt.prepert(:,end-49:end) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax3,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.2 0.2 1])
patch(ax3,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.2 0.2 1],'FaceAlpha',0.5,'LineStyle','none')
clear dt
dt.og=timeCourseUnbiased{2}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{2}.param{4}.cond{2}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{2}.param{4}.cond{6}(2:length(x3)+1,:)';
dt.wash=timeCourseUnbiased{2}.param{4}.cond{7}(1:length(x4),:)';
%dt.all=[dt.og dt.prepert dt.adapt dt.wash];
dt.all=[dt.prepert(:,1:50) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax3,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.8 0 0])
patch(ax3,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.8 0 0],'FaceAlpha',0.5,'LineStyle','none')
%clear dt


hold(ax4)%control and full abrupt on treadmill
patch(ax4,[tmInd2,fliplr(tmInd2)],[yaxmin*ones(1,length(tmInd2)) yaxmax*ones(1,length(tmInd2))],[0.9 0.9 0.9],'FaceAlpha',0.5,'LineStyle','none')

dt.og=timeCourseUnbiased{7}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{7}.param{4}.cond{6}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{7}.param{4}.cond{6}(length(x2)+1:length(x2)+length(x3),:)';
dt.wash=timeCourseUnbiased{7}.param{4}.cond{9}(1:length(x4),:)';
%dt.all=[dt.og dt.prepert dt.adapt dt.wash];
dt.all=[dt.prepert(:,end-49:end) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax4,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.2 0.2 1])
patch(ax4,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.2 0.2 1],'FaceAlpha',0.5,'LineStyle','none')
clear dt
dt.og=timeCourseUnbiased{6}.param{4}.cond{1}(1:length(x1),:)';
dt.prepert=timeCourseUnbiased{6}.param{4}.cond{2}(1:length(x2),:)';
dt.adapt=timeCourseUnbiased{6}.param{4}.cond{6}(2:length(x3)+1,:)';
dt.wash=timeCourseUnbiased{6}.param{4}.cond{9}(1:length(x4),:)';
%dt.all=[dt.og dt.prepert dt.adapt dt.wash];
dt.all=[dt.prepert(:,1:50) dt.adapt dt.wash(:,1:20)];
nt=nanstd(dt.all)./sqrt(size(dt.og,1));
plot(ax4,1:size(dt.all,2),nanmean(dt.all),'ok','MarkerFaceColor',[0.8 0 0])
patch(ax4,[1:size(dt.all,2),fliplr(1:size(dt.all,2))],[nanmean(dt.all)+nt fliplr(nanmean(dt.all)-nt)],[0.8 0 0],'FaceAlpha',0.5,'LineStyle','none')
%clear dt
