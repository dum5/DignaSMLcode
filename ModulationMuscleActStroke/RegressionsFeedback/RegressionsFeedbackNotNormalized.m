...
%     
    ...
    if speedMatchFlag==0
        save([matDataDir,'GroupMedianRegressionFullNoNorm.mat'],'CmodelFit2','SmodelFit2');
    elseif speedMatchFlag==1
        save([matDataDir,'GroupMedianRegressionSpeedMatchNoNorm.mat'],'CmodelFit2','SmodelFit2');
    end
