...
%     title('N=10 per group')
    ...
    if speedMatchFlag==0
        save([matDataDir,'GroupMedianRegressionFullFlipped.mat'],'CmodelFit2','SmodelFit2');
    elseif speedMatchFlag==1
        save([matDataDir,'GroupMedianRegressionSpeedMatchFlipped.mat'],'CmodelFit2','SmodelFit2');
    end
