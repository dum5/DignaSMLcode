...
%     Sr1=Sr1.uncentered;
    ...
    CmodelFit2=fitlm(ttCHalfFlipped,'eP_lA~eA+eAT-1','RobustOpts',rob);
...
%     Cr2=Cr2.uncentered;
    ...
    SmodelFit2=fitlm(ttSHalfFlipped,'eP_lA~eA+eAT-1','RobustOpts',rob);
...
%     Sr2=Sr2.uncentered;
     ...
     %control regression on Normalized vectors
    CmodelFit3=fitlm(ttCHalfFlippedFast,'eP_lA~eA+eAT-1','RobustOpts',rob);
%     Clearn2=CmodelFit2.Coefficients.Estimate;
%     Clearn2CI=CmodelFit2.coefCI;
%     Cr2=uncenteredRsquared(CmodelFit2);
%     Cr2=Cr2.uncentered;
    ...
    %stroke regression on Normalized vectors
    SmodelFit3=fitlm(ttSHalfFlippedFast,'eP_lA~eA+eAT-1','RobustOpts',rob);
%     Slearn2=SmodelFit2.Coefficients.Estimate;
%     Slearn2CI=SmodelFit2.coefCI;
%     Sr2=uncenteredRsquared(SmodelFit2);
%     Sr2=Sr2.uncentered;
