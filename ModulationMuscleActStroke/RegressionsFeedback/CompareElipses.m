function aa=CompareElipses(Cmod,Smod,color,ax);
...
set(dt1,'Color',color,'LineWidth',2)
...
set(dt2,'Color',color,'LineWidth',2)

hs=patch(ax,dt2.XData,dt2.YData,[1 1 1],'EdgeColor',color);
hatchfill2(hs)
