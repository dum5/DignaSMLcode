...
%     Sr1=Sr1.uncentered;
    ...
    CmodelFit2=fitlm(ttCFast,'eP_lA~eA+eAT-1','RobustOpts',rob);
...
%     Cr2=Cr2.uncentered;
    ...
    SmodelFit2=fitlm(ttSFast,'eP_lA~eA+eAT-1','RobustOpts',rob);
...
%     Sr2=Sr2.uncentered;
     ...
     %control regression on Normalized vectors
    CmodelFit3=fitlm(ttCFlippedFast,'eP_lA~eA+eAT-1','RobustOpts',rob);
%     Clearn2=CmodelFit2.Coefficients.Estimate;
%     Clearn2CI=CmodelFit2.coefCI;
%     Cr2=uncenteredRsquared(CmodelFit2);
%     Cr2=Cr2.uncentered;
    ...
    %stroke regression on Normalized vectors
    SmodelFit3=fitlm(ttSFlippedFast,'eP_lA~eA+eAT-1','RobustOpts',rob);
%     Slearn2=SmodelFit2.Coefficients.Estimate;
%     Slearn2CI=SmodelFit2.coefCI;
%     Sr2=uncenteredRsquared(SmodelFit2);
%     Sr2=Sr2.uncentered;
...
%     
    ...
    if speedMatchFlag==0
        save([matDataDir,'GroupMedianRegressionFastLegFullNoNorm.mat'],'CmodelFit2','SmodelFit2','CmodelFit3','SmodelFit3');
    elseif speedMatchFlag==1
        save([matDataDir,'GroupMedianRegressionFastLegSpeedMatchNoNorm.mat'],'CmodelFit2','SmodelFit2','CmodelFit3','SmodelFit3');
    end
