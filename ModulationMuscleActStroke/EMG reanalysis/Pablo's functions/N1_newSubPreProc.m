...
%THIS PART IS ONLY NEEDED IF YOU WANT TO DO PROCESSING
% clearvars
% subs={'1','2'};
...
close all
clc
strokesNames={'P0001','P0002','P0003','P0004','P0005','P0006','P0009','P0010','P0011','P0012','P0013','P0014','P0015','P0016'};
%healthies={'0003','0004','0008'};
     ...
     for subCountFlag=0%0:1 %Unimplemented
         for useLateAdapBase=0%:1
             for plotSym=0%:1 %Unimplemented
                run N19D_assessGroupedEMGEvolution.m
             end
         end
     end
  end
