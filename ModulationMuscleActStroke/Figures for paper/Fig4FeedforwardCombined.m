...
hs=bar(ph(1,2),2,nanmedian(TStroke.FF_Quad),'BarWidth',0.5,'FaceColor',[1 1 1],'EdgeColor',[0 0 0],'LineWidth',2);
hatchfill2(hs)
...
hs=bar(ph(2,1),2,nanmedian(TStroke.FF_skneeAngleAtSHS),'BarWidth',0.5,'FaceColor',[1 1 1],'EdgeColor',[0 0 0],'LineWidth',2);
hatchfill2(hs)
