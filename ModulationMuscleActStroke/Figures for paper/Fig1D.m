...
plot(-2*[1 1],3.45+[.5 3.5],'LineWidth',4,'Color',ccc(1,:),'Clipping','off')
text(-2.5,6.5,'FAST','Color',ccc(1,:),'Rotation',90,'FontSize',20,'FontWeight','bold')
plot(-2*[1 1],[.5 3.5],'LineWidth',4,'Color',ccc(2,:),'Clipping','off')
text(-2.5,3,'SLOW','Color',ccc(2,:),'Rotation',90,'FontSize',20,'FontWeight','bold')
