...
%% Colormap:
%colorScheme
ccd=[0.6 0.3 0.5;0.95 0.7 0.13;0.3 0.75 0.93];
...
paramList={'spatialContribution','stepTimeContribution','netContribution'};
suffix='Norm2';
...
[~,Idx]=sort(patientData(3,1,:));Idx=squeeze(Idx);%sort patients according to ascending net
patientData(1:3,1,:)=patientData(1:3,1,Idx);
varPatientData(1:3,1,:)=varPatientData(1:3,1,Idx);
FM=FM(Idx);
...
paramList2={'StepPosition','StepTime','StepAsym'};
