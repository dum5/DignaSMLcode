...
t9=text(ax2,1,33,2,'lA_B','Color','k','FontSize',16,'FontWeight','Bold','Clipping','off');
...
ylabel(ph(1,1),'|| lA_B ||','FontWeight','bold')
...
set(ph(1,2),'XLim',[0.5 2.5],'YLim',[0 0.6],'XTickLabel',{''},'YTick',[0 0.3 0.6])
ylabel(ph(1,2),'\Delta Quad Act lA_B','FontWeight','bold')
plot(ph(1,2),[1 2],[0.55 0.55],'LineWidth',2,'Color','k')
...
ylabel(ph(2,1),'\Delta \theta sKnee lA_B','FontWeight','bold')
...
ylabel(ph(2,2),'\Delta\theta sKnee lA_B','FontWeight','bold')
xlabel(ph(2,2),'\Delta Quad Act lA_B','FontWeight','bold')
