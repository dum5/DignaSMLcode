...
tempMap=[bsxfun(@plus,ex1.^(1/gamma),bsxfun(@times,1-ex1.^(1/gamma),[0:.01:1]'));bsxfun(@plus,ex2.^(1/gamma),bsxfun(@times,1-ex2.^(1/gamma),[1:-.01:0]'))].^gamma;
map2=flipud([tempMap(1:100,:);repmat([1 1 1],200,1);tempMap(101:200,:)]);
