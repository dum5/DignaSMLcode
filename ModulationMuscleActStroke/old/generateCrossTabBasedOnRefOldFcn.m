function [dataBinary,dataCount,ATS]=generateCrossTab(this,epoch,refepoch,Prefix,mindif,signmatrix,fdr,refgroup)
%keyboard

%first determine which epochs are significant in controls
ft=figure;
ac=subplot(1,1,1);
[ft,ac,labelsD,dataEcD,dataRefcD]=plotCheckerboards(refgroup,Prefix,epoch,ft,ac,refepoch,false,'nanmedian');%make sure that flipLR is off, because biniary data are also not time shifted.
close gcf;
