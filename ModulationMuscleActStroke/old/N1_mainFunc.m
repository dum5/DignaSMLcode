...
[f,p1c,ps1,pd1,pvalc1,pvals1,pvalb1,hc1,hs1,hb1,dataEc1,dataEs1]=plotBGcomp(f,pc1,ps1,pd1,eps,reps,0,newLabelPrefix,groups,0.05,0.1,'nanmedian',evLabel);
...
set(ha(:,1),'CLim',[-1 1].*0.5);
set(ha(:,2:end),'YTickLabels',{},'CLim',[-1 1].*.5);
